...
if __name__ == "__main__":
    ...
    train_dataset=images_Dataset(train[:1000],y_train[:1000],device,256)
    train_dataloader=DataLoader(train_dataset,batch_size=32,shuffle=True,num_workers=4)

    val_dataset=images_Dataset(val[:200],y_val[:200],device,256)
    ...
    for epoch in range(EPOCHS):
        ...
        #         }
        #     torch.save(checkpoint, 'Models/Classification_Models/Best_Classification_model_b0_512_new.pth')
        # checkpoint = {
        #             "model_state_dict": model.state_dict(),
        #             "optimizer_state_dict": optimizer.state_dict(),
        #             "encoder_path": model.path_to_encoder,
        ...
        #         }
        # torch.save(checkpoint, 'Models/Classification_Models/Last_Classification_model_b0_512_new.pth')
