...
if __name__ == "__main__":
    ...
    train_dataset=images_Dataset(train[:100000],y_train[:100000],device,256)
    train_dataloader=DataLoader(train_dataset,batch_size=32,shuffle=True,num_workers=4)

    val_dataset=images_Dataset(val[:20000],y_val[:20000],device,256)
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss_value <= best:
            ...
            torch.save(checkpoint, 'Models/Contrastive_Models/Best_Contrastive_model_b0_256_new.pth')
        checkpoint = {
                    "model_state_dict": model.state_dict(),
                    "model_type": model.type,
                    "optimizer_state_dict": optimizer.state_dict()
                }
        torch.save(checkpoint, 'Models/Contrastive_Models/Last_Contrastive_model_b0_256_new.pth')
