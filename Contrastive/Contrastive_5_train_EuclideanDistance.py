...
from utils.data_acquisition import images_Dataset,data_set_5
...
if __name__ == "__main__":
    ...
    PATH_TO_SAVE=f'Models/Contrastive_Models/Contrastive_b0_{EMBEDDING_SIZE}_{BATCH_SIZE}_5_EuclideanDistance{MARGIN}.pth'
